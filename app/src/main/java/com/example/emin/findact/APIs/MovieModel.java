...
public class MovieModel {
    ...
    public MovieModel(String firebaseId, int movieId, String title, String release_date, ArrayList<String> genre, String vote_average,String popularity, String poster_path, String overview, String language) {
    ...
    public MovieModel(Bundle bundle){
        ...
        this.popularity = bundle.getString("popularity");
    ...
    public Bundle MovieDataToBundle(){
        ...
        bundle.putString("popularity", this.popularity);
