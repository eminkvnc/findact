...
public class IGDbAPI {
    ...
    public void searchGame(String game_name, final ArrayList<GameModel> gameModelArrayList, OnTaskCompletedListener onTaskCompletedListener){

        gameModelArrayList.clear();
        this.listener = onTaskCompletedListener;

        DownloadData downloadData = new DownloadData(game_name,gameModelArrayList,listener);
    ...
    private static class DownloadData extends AsyncTask<Void, Void, Void> {
        ...
        DownloadData(String game_name, ArrayList<GameModel> gameModelArrayList, OnTaskCompletedListener listener) {
